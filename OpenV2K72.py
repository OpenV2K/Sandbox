...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/8/12 - Version 72)")
    ...
    def _build_gui(self):
        ...
        for code in sorted(_LANG_NAMES, key=lambda c: _LANG_NAMES[c]):
            self._lang_combo.addItem(_LANG_NAMES[code], code)

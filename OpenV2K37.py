...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/7/23 - Version 37)")
    ...
    def _build_gui(self):
        ...
        # Meter (moves up because dB row is now merged into the header)

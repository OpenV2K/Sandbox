...
def detect_hackrf():
    try:
        ...
        if 'HackRF' in output and result.returncode == 0:
            ...
            # Pass 1: line explicitly about firmware, NOT a tool-version line
            for l in lines:
                ll = l.lower()
                if ('firmware' in ll and 'version' in ll and ':' in l
            ...
            if firmware is None:
                firmware = 'run hackrf_info to check'
...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/7/23 - Version 19)")

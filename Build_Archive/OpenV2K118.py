...
class SwapButton(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self._btn.setStyleSheet(
            "QPushButton {{ background-color:#ADD8E6; color:#1c4f8a;"
            " border-radius:{r}px; font-weight:bold; font-size:8pt;"
            " padding:0px; }}"
            "QPushButton:hover {{ background-color:#bfe6f5; }}"
            "QPushButton:pressed {{ background-color:#9bcfe0; }}".format(r=r))
...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/8/14 - Version 118)")

...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/8/12 - Version 107)")
    ...
    def _build_gui(self):
        ...
        self._power_reset_btn.setFixedWidth(44)
        self._power_reset_btn.setFixedHeight(44)

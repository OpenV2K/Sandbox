...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/8/12 - Version 105)")
    ...
    def _build_gui(self):
        ...
        # TX button moved down 8px per request.
        ...
        pc_box_hbox.setContentsMargins(8, 1, 4, 2); pc_box_hbox.setSpacing(6)
        ...
        self._power_reset_btn.setFixedWidth(48)
        self._power_reset_btn.setFixedHeight(48)

...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/7/25 - Version 51)")
    ...
    def _build_gui(self):
        ...
        self._sl_pulse = LabelledSlider("Pulse (\u00b5s)", 5, 150, 5, self._pulse_us,

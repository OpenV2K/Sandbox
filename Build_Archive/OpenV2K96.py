...
'en': {
    ...
    'power_calc_title':             'High Power Microwave Calculator',
    'power_calc_summary':
...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/8/12 - Version 96)")
    ...
    def _build_gui(self):
        ...
        self._power_summary_lbl.setStyleSheet("font-size:9px; color:#555;")
    ...
    def _update_power_calc(self):
        ...
        # Row 2: Total Energy Output (2 power tiers: 1.5kW, 4kW)
        ...
        # Row 3: Recommended amplifier output (Watts) to hit a ~16mJ/pulse
        # target at the CURRENT pulse width: P = Energy / pulse_duration.

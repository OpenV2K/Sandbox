...
class SegmentedMeter(QtWidgets.QWidget):
    ...
    def paintEvent(self, event):
        ...
        # (the previous formula subtracted the gap from every segment's
        # own height without compensating, leaving a 2px unpainted band
...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/8/14 - Version 125)")
    ...
    def _build_gui(self):
        ...
        live_col.addSpacing(10)   # whitespace above the meter only
        ...
        live_bar_row.addStretch()
        live_col.addLayout(live_bar_row, 1)   # stretch -- meter fills
                                               # remaining height, restoring
        ...
        peak_col.addSpacing(10)   # whitespace above the meter only
        ...
        peak_bar_row.addStretch()
        peak_col.addLayout(peak_bar_row, 1)   # stretch -- same as Live

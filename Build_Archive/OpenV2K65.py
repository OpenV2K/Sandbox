...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/8/12 - Version 65)")
    ...
    def _prime_mbrola_async(self):
        ...
        (not MBROLA) so there is no risk of sharing MBROLA temp files or
        pipes with the first real synthesis the user triggers."""
        def _prime():
            import tempfile
            for cmd in ['espeak-ng', 'espeak']:
                try:

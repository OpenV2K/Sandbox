...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        # Format: YYYY/M/D
        self.setWindowTitle("OpenV2K (2026/8/16 - Version 158)")
    ...
    def _build_gui(self):
        ...
        dc_vbox.addLayout(meters_row)   # no stretch -- see trailing
                                        # stretch after dc_lbl below
        ...
        dc_vbox.addStretch(1)   # leftover space (if any) absorbed here,
                                # at the bottom, not pushed through the
                                # middle of the layout via meters_row

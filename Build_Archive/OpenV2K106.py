...
'en': {
    ...
    'power_calc_summary':
        ...
        'Energy from a .22 LR rifle round: ~200 Joules.',
...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/8/12 - Version 106)")
    ...
    def _build_gui(self):
        ...
        self._power_summary_lbl.setStyleSheet("font-size:10px; color:#333;")
        self._power_summary_lbl.setAlignment(QtCore.Qt.AlignCenter)
        ...
        pc_box_hbox.setContentsMargins(8, 1, 4, 16); pc_box_hbox.setSpacing(6)
        ...
        self._power_reset_btn.setFixedWidth(60)
        self._power_reset_btn.setFixedHeight(60)
        self._power_reset_btn.setStyleSheet(
            "QPushButton {"
            "  background-color: #ADD8E6; color: #1c4f8a;"
            "  border-radius: 13px; font-weight: bold; font-size: 10pt; }"

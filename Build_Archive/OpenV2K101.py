...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/8/12 - Version 101)")
    ...
    def _update_power_calc(self):
        ...
        # 1M/2M apply the standard isotropic-radiator power-density
        ...
        p_2m = p_point_blank * 4.0 * math.pi * (2.0 ** 2)
        self._power_recommended_lbl.setText(
            "{} {:.0f}W (Point Blank), {:.0f}W (1m), {:.0f}W (2m)".format(
                _tr("power_recommended"), p_point_blank, p_1m, p_2m))

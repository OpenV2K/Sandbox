...
'en': {
    ...
    'power_reset':                  'Reset',
    'power_session_count':          'Session Pulse Count Total:',
...
'de': {
    ...
    'power_session_count':          'Sitzungs-Pulszähler gesamt:',
...
'fr': {
    ...
    'power_session_count':          'Total des impulsions de la session :',
...
'es': {
    ...
    'power_session_count':          'Total de pulsos de la sesión:',
...
'it': {
    ...
    'power_session_count':          'Totale impulsi sessione:',
...
'sv': {
    ...
    'power_session_count':          'Sessionens pulsantal totalt:',
...
'no': {
    ...
    'power_session_count':          'Sesjonens pulsantall totalt:',
    'power_per_pulse':              'Effekt per puls:',
...
'ru': {
    ...
    'power_session_count':          'Всего импульсов за сеанс:',
...
'hi': {
    ...
    'power_reset':                  'रीसेट',
    'power_session_count':          'सत्र पल्स कुल गणना:',
...
'ja': {
    ...
    'power_reset':                  'リセット',
    'power_session_count':          'セッションパルス総数:',
...
'ar': {
    ...
    'power_session_count':          'إجمالي عدد النبضات في الجلسة:',
...
'bn': {
    ...
    'power_reset':                  'রিসেট',
    'power_session_count':          'সেশন পালস মোট গণনা:',
...
'pt': {
    ...
    'power_reset':                  'Repor',
    'power_session_count':          'Total de pulsos da sessão:',
...
'ur': {
    ...
    'power_reset':                  'ری سیٹ',
    'power_session_count':          'سیشن پلس کل تعداد:',
...
'id': {
    ...
    'power_session_count':          'Total Hitungan Pulsa Sesi:',
...
'ms': {
    ...
    'power_session_count':          'Jumlah Kiraan Denyut Sesi:',
...
'sw': {
    ...
    'power_session_count':          'Jumla ya Idadi ya Mipigo ya Kikao:',
...
'tr': {
    ...
    'power_reset':                  'Sıfırla',
    'power_session_count':          'Oturum Darbe Toplam Sayısı:',
...
'vi': {
    ...
    'power_reset':                  'Đặt lại',
    'power_session_count':          'Tổng số xung của phiên:',
...
'ko': {
    ...
    'power_reset':                  '재설정',
    'power_session_count':          '세션 펄스 총 개수:',
...
'fa': {
    ...
    'power_session_count':          'مجموع تعداد پالس نشست:',
...
'pa': {
    ...
    'power_reset':                  'ਰੀਸੈੱਟ',
    'power_session_count':          'ਸੈਸ਼ਨ ਪਲਸ ਕੁੱਲ ਗਿਣਤੀ:',
...
'te': {
    ...
    'power_reset':                  'రీసెట్',
    'power_session_count':          'సెషన్ పల్స్ మొత్తం లెక్క:',
...
'mr': {
    ...
    'power_reset':                  'रीसेट',
    'power_session_count':          'सत्र पल्स एकूण संख्या:',
...
'ta': {
    ...
    'power_reset':                  'மீட்டமை',
    'power_session_count':          'அமர்வு துடிப்பு மொத்த எண்ணிக்கை:',
...
'pl': {
    ...
    'power_reset':                  'Resetuj',
    'power_session_count':          'Łączna liczba impulsów sesji:',
...
'ro': {
    ...
    'power_session_count':          'Total impulsuri sesiune:',
...
'nl': {
    ...
    'power_session_count':          'Totaal aantal pulsen sessie:',
...
'hu': {
    ...
    'power_session_count':          'Munkamenet impulzusok összesen:',
...
'el': {
    ...
    'power_session_count':          'Σύνολο παλμών συνεδρίας:',
...
'cs': {
    ...
    'power_session_count':          'Celkový počet pulzů relace:',
...
'hr': {
    ...
    'power_reset':                  'Poništi',
    'power_session_count':          'Ukupan broj impulsa sesije:',
...
'lt': {
    ...
    'power_session_count':          'Sesijos impulsų iš viso:',
...
'uk': {
    ...
    'power_reset':                  'Скинути',
    'power_session_count':          'Загальна кількість імпульсів сеансу:',
...
'ca': {
    ...
    'power_session_count':          'Total de polsos de la sessió:',
...
'fi': {
    ...
    'power_reset':                  'Nollaa',
    'power_session_count':          'Istunnon pulssien kokonaismäärä:',
...
'bg': {
    ...
    'power_session_count':          'Общ брой импулси на сесията:',
...
'sr': {
    ...
    'power_reset':                  'Ресетуј',
    'power_session_count':          'Укупан број импулса сесије:',
...
'da': {
    ...
    'power_calculation':            'Effektberegning',
    'power_reset':                  'Nulstil',
    'power_session_count':          'Sessionens samlede pulsantal:',
...
'sk': {
    ...
    'power_session_count':          'Celkový počet impulzov relácie:',
...
'be': {
    ...
    'power_reset':                  'Скінуць',
    'power_session_count':          'Агульная колькасць імпульсаў сесіі:',
    ...
    'save_description':
        ...
        'Пры частаце дыскрэтызацыі 2 МГц: каля 16 МБ/с.\n'
        '30-секундны запіс займае каля 480 МБ.\n'
        'Плануйце месца на дыску перад доўгімі запісамі.\n'
        'Waterfall: кароткачасовае FFT праз numpy,\n'
        'адлюстравана каляровай картай inferno з matplotlib.\n'
        'Адкрываецца аўтаматычна ў сістэмным праглядальніку.',
...
'et': {
    ...
    'power_session_count':          'Seansi impulsside koguarv:',
    ...
    'save_description':
        ...
        '2 MHz diskreetimissagedusel: umbes 16 MB/sek.\n'
        '30-sekundiline salvestus kasutab umbes 480 MB.\n'
        'Planeeri salvestusruum enne pikki salvestusi.\n'
        'Waterfall: lühiajaline FFT numpy kaudu,\n'
        'renderdatud matplotlibi inferno värvikaardiga.\n'
        'Avaneb automaatselt süsteemi vaataja aknas.',
...
'is': {
    ...
    'power_session_count':          'Heildarfjöldi púlsa í lotu:',
    ...
    'save_description':
        ...
        'Við 2 MHz sýnitíðni: um 16 MB/sek.\n'
        '30 sekúndna upptaka notar um 480 MB.\n'
        'Skipuleggðu geymslupláss fyrir langar upptökur.\n'
        'Waterfall: skammtíma FFT í gegnum numpy,\n'
        'myndgert með inferno litakorti matplotlib.\n'
        'Opnast sjálfkrafa í kerfisskoðara.',
...
'lv': {
    ...
    'power_session_count':          'Sesijas impulsu kopskaits:',
    ...
    'save_description':
        ...
        'Pie 2 MHz paraugu ņemšanas ātruma: apm. 16 MB/sek.\n'
        '30 sekunžu ieraksts izmanto apm. 480 MB.\n'
        'Ieplānojiet krātuves vietu pirms gariem ierakstiem.\n'
        'Waterfall: īslaicīgs FFT, izmantojot numpy,\n'
        'attēlots ar matplotlib inferno krāsu karti.\n'
        'Automātiski atveras sistēmas skatītājā.',
...
'lb': {
    ...
    'power_session_count':          'Sitzung Impuls Gesamtzuel:',
    ...
    'save_description':
        ...
        'Bei enger 2-MHz-Sampleraat: ongeféier 16 MB/Sek.\n'
        'Eng 30-Sekonn-Opnam benotzt ongeféier 480 MB.\n'
        'Plangt de Späicherplaz virun laange Opnamen.\n'
        'Waterfall: kuerzzäiteg FFT via numpy,\n'
        'gerendert mat der matplotlib inferno Faarwkaart.\n'
        'Geet automatesch am Systemvisualiséierer op.',
...
'mn': {
    ...
    'power_session_count':          'Сессийн импульсийн нийт тоо:',
    ...
    'save_description':
        ...
        '2 МГц дээжийн давтамжтай үед: орчим 16 МБ/сек.\n'
        '30 секундын бичлэг орчим 480 МБ ашиглана.\n'
        'Урт бичлэгийн өмнө хадгалах орон зайгаа төлөвлөнө үү.\n'
        'Waterfall: numpy ашиглан богино хугацааны FFT,\n'
        'matplotlib-ийн inferno өнгөний зурагласан.\n'
        'Системийн харагчид автоматаар нээгдэнэ.',
    'record_iq':                   'IQ бичих',
...
'mi': {
    ...
    'power_session_count':          'Tapeke Tatau Whiu o te Wā:',
    ...
    'save_description':
        ...
        'I te reiti tauira 2 MHz: tata ki te 16 MB/hēkona.\n'
        'Ka whakamahia e te hopu 30 hēkona te 480 MB.\n'
        'Whakamaheretia tō wāhi rokiroki i mua i ngā hopu roa.\n'
        'Waterfall: FFT wā-poto mā roto i te numpy,\n'
        'whakaahuatia ki te mapi tae inferno a matplotlib.\n'
        'Ka tuwhera aunoa ki te kaititiro pūnaha.',
    'record_iq':                   'Hopu IQ',
...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/8/12 - Version 91)")
    ...
    def _retranslate_ui(self):
        ...
        self._power_calc_box.setTitle(_tr("power_calculation"))
        self._power_reset_lbl.setText(
            "<a href='#' style='color:#2a6ebb; text-decoration:none;'>{}</a>"
            .format(_tr("power_reset")))
        self._update_power_calc()   # rebuilds both rows with new prefix text
    ...
    def _build_gui(self):
        ...
        # -- Power Calculation -- reserved space below Noise/Silence and
        # ZCR Shaping (rows 4-6 in those two columns were left empty when
        # Signal Conditioning grew to 6 rows).  Same QGroupBox treatment as
        # Optional Filters -- title sits centred on the box's top border.
        self._power_calc_box = QtWidgets.QGroupBox(_tr("power_calculation"))
        self._power_calc_box.setStyleSheet(
            "QGroupBox { font-size:9pt; }")
        pc_vbox = QtWidgets.QVBoxLayout(self._power_calc_box)
        pc_vbox.setContentsMargins(6, 2, 6, 4); pc_vbox.setSpacing(3)

        # Reset link -- right-aligned near the top, beside the border title
        reset_row = QtWidgets.QHBoxLayout()
        reset_row.setContentsMargins(0, 0, 0, 0)
        reset_row.addStretch(1)
        self._power_reset_lbl = QtWidgets.QLabel(
            "<a href='#' style='color:#2a6ebb; text-decoration:none;'>{}</a>"
            .format(_tr("power_reset")))
        self._power_reset_lbl.setStyleSheet("font-size:8px;")
        self._power_reset_lbl.linkActivated.connect(self._cb_power_reset)
        reset_row.addWidget(self._power_reset_lbl)
        pc_vbox.addLayout(reset_row)

        # Row 1: Session Pulse Count Total (rolling counter, no comma delimiter)
        self._power_count_lbl = QtWidgets.QLabel()
        self._power_count_lbl.setStyleSheet("font-size:8px; color:#333;")
        self._power_count_lbl.setWordWrap(True)
        pc_vbox.addWidget(self._power_count_lbl)

        # Row 2: Power Per Pulse -- pulse_width x hypothetical amplifier
        # power (50W / 2kW / 4kW) = energy per pulse in Joules.  Computed
        # live; see _update_power_calc() -- called on pulse-width slider
        # change and refreshed on the display timer.
        self._power_perpulse_lbl = QtWidgets.QLabel()
        self._power_perpulse_lbl.setStyleSheet("font-size:8px; color:#333;")
        self._power_perpulse_lbl.setWordWrap(True)
        pc_vbox.addWidget(self._power_perpulse_lbl)

        pc_vbox.addStretch(1)
        opt_layout.addWidget(self._power_calc_box, 4, 1, 3, 2)
        ...
        self._save_path_lbl.setMinimumHeight(150)
    ...
    def _build_blocks(self):
        ...
        # RBJ cookbook's a1/a2 assume y[n] = ... - a1*y[n-1] - a2*y[n-2]
        # (feedback SUBTRACTED).  GNU Radio's iir_filter_ffd instead computes
        # y[n] = ... + fbtaps[k]*y[n-k] (feedback ADDED), so the RBJ a1/a2
        # must be negated here or the notch's poles land OUTSIDE the unit
        # circle (was |pole|=2.41 -- an unstable filter that blows up to
        # NaN/Inf within ~20 samples and kills the entire downstream chain
        # every time the notch was enabled).  Negating gives poles at
        # |pole|=0.9999, just inside the unit circle -- stable, narrow notch.
    ...
    def _update_power_calc(self):
        """
        Refreshes both Power Calculation rows.  Called on every pulse-width
        slider move (immediate math update) and every 100ms display tick
        (keeps the rolling pulse counter live), plus once after a language
        switch so the translated label prefixes stay in sync.
        """
        ...
        for p_w in self._POWER_LEVELS_W:
            energy_j = pulse_s * p_w
            tag = "{:.0f}W".format(p_w) if p_w < 1000 else \
                 "{:.0f}kW".format(p_w / 1000.0)
            parts.append("{:.5f} J@{}".format(energy_j, tag))
        self._power_perpulse_lbl.setText(
            "{} {}".format(_tr("power_per_pulse"), "   ".join(parts)))

    def _cb_power_reset(self, _href):
        """Reset link clicked -- zero the session pulse counter."""

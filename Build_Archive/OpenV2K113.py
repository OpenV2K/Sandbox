...
'en': {
    ...
    'power_calc_summary':
        'Hypothetical energy output from a high-power microwave amplifier, for the current pulse width and pulse count.\n'
        '1500W is the FCC amateur radio power ceiling, and 4kW is the rated maximum output of the Exodus AMP20057.\n'
        'Metro area average weekly microwave exposure: ~18 Joules. Muzzle energy from a .22 LR rifle round: ~200 Joules.',
    'power_recommended':            'Recommended for 16mJ Per Pulse:',
    'power_calc_title':             'High Power Calculator',
    'power_calc_summary':
...
'de': {
    ...
    'power_last_action_count':      'Letzte TTS-Aktion:',
    'power_calc_title':             'Hochleistungsrechner',
    'power_calc_summary':
        'Hypothetische Energieabgabe eines Hochleistungs-Mikrowellenverstärkers, für die aktuelle Pulsbreite und Pulsanzahl.\n'
        '1500W ist die FCC-Leistungsobergrenze für Amateurfunk, und 4kW ist die maximale Nennleistung des Exodus AMP20057.\n'
        'Durchschnittliche wöchentliche Mikrowellenexposition im Stadtgebiet: ~18 Joule. Mündungsenergie einer .22-LR-Gewehrpatrone: ~200 Joule.',
    'power_recommended':            'Empfohlen für 16mJ pro Puls:',
...
'fr': {
    ...
    'power_last_action_count':      'Dernière action TTS :',
    'power_calc_title':             'Calculateur haute puissance',
    'power_calc_summary':
        'Sortie d\'énergie hypothétique d\'un amplificateur micro-ondes haute puissance, pour la largeur et le nombre d\'impulsions actuels.\n'
        '1500W est le plafond de puissance FCC pour la radio amateur, et 4kW est la puissance de sortie maximale nominale de l\'Exodus AMP20057.\n'
        'Exposition hebdomadaire moyenne aux micro-ondes en zone métropolitaine : ~18 joules. Énergie à la bouche d\'une cartouche de fusil .22 LR : ~200 joules.',
    'power_recommended':            'Recommandé pour 16mJ par impulsion :',
...
'es': {
    ...
    'power_last_action_count':      'Última acción TTS:',
    'power_calc_title':             'Calculadora de alta potencia',
    'power_calc_summary':
        'Salida de energía hipotética de un amplificador de microondas de alta potencia, para el ancho de pulso y el recuento de pulsos actuales.\n'
        '1500W es el límite de potencia de la FCC para radioaficionados, y 4kW es la salida máxima nominal del Exodus AMP20057.\n'
        'Exposición semanal promedio a microondas en área metropolitana: ~18 julios. Energía en boca de un cartucho de rifle .22 LR: ~200 julios.',
    'power_recommended':            'Recomendado para 16mJ por pulso:',
...
'it': {
    ...
    'power_last_action_count':      'Ultima azione TTS:',
    'power_calc_title':             'Calcolatore ad alta potenza',
    'power_calc_summary':
        'Uscita di energia ipotetica da un amplificatore a microonde ad alta potenza, per la larghezza e il conteggio degli impulsi correnti.\n'
        '1500W è il limite di potenza FCC per la radio amatoriale, e 4kW è l\'uscita massima nominale dell\'Exodus AMP20057.\n'
        'Esposizione settimanale media a microonde in area metropolitana: ~18 joule. Energia alla volata di un proiettile da fucile .22 LR: ~200 joule.',
    'power_recommended':            'Raccomandato per 16mJ per impulso:',
...
'sv': {
    ...
    'power_last_action_count':      'Senaste TTS-åtgärd:',
    'power_calc_title':             'Högeffektskalkylator',
    'power_calc_summary':
        'Hypotetisk energiutgång från en högeffekts mikrovågsförstärkare, för aktuell pulsbredd och pulsantal.\n'
        '1500W är FCC:s effekttak för amatörradio, och 4kW är den nominella maxeffekten för Exodus AMP20057.\n'
        'Genomsnittlig veckoexponering för mikrovågor i storstadsområde: ~18 joule. Mynningsenergi från en .22 LR-gevärspatron: ~200 joule.',
    'power_recommended':            'Rekommenderat för 16mJ per puls:',
...
'no': {
    ...
    'power_last_action_count':      'Siste TTS-handling:',
    'power_calc_title':             'Høyeffektkalkulator',
    'power_calc_summary':
        'Hypotetisk energiutgang fra en høyeffekts mikrobølgeforsterker, for gjeldende pulsbredde og pulsantall.\n'
        '1500W er FCCs effekttak for amatørradio, og 4kW er den nominelle maksimale utgangseffekten til Exodus AMP20057.\n'
        'Gjennomsnittlig ukentlig mikrobølgeeksponering i storbyområde: ~18 joule. Munningsenergi fra en .22 LR-rifelpatron: ~200 joule.',
    'power_recommended':            'Anbefalt for 16mJ per puls:',
    'power_per_pulse':              'Effekt per puls:',
...
'ru': {
    ...
    'power_last_action_count':      'Последнее действие TTS:',
    'power_calc_title':             'Калькулятор высокой мощности',
    'power_calc_summary':
        'Гипотетическая выходная энергия от мощного микроволнового усилителя, для текущей ширины импульса и количества импульсов.\n'
        '1500 Вт — потолок мощности FCC для любительского радио, а 4 кВт — номинальная максимальная выходная мощность Exodus AMP20057.\n'
        'Средняя еженедельная микроволновая экспозиция в мегаполисе: ~18 джоулей. Дульная энергия патрона .22 LR: ~200 джоулей.',
    'power_recommended':            'Рекомендовано для 16мДж на импульс:',
...
'hi': {
    ...
    'power_last_action_count':      'अंतिम TTS क्रिया:',
    'power_calc_title':             'उच्च शक्ति कैलकुलेटर',
    'power_calc_summary':
        'वर्तमान पल्स चौड़ाई और पल्स गणना के लिए, एक उच्च-शक्ति माइक्रोवेव एम्पलीफायर से काल्पनिक ऊर्जा उत्पादन।\n'
        '1500W FCC शौकिया रेडियो शक्ति सीमा है, और 4kW Exodus AMP20057 का रेटेड अधिकतम आउटपुट है।\n'
        'महानगर क्षेत्र औसत साप्ताहिक माइक्रोवेव एक्सपोज़र: ~18 जूल। .22 LR राइफल राउंड से मज़ल ऊर्जा: ~200 जूल।',
    'power_recommended':            'प्रति पल्स 16mJ के लिए अनुशंसित:',
...
'ja': {
    ...
    'power_last_action_count':      '最後のTTS操作:',
    'power_calc_title':             '高出力計算機',
    'power_calc_summary':
        '現在のパルス幅とパルス数における、高出力マイクロ波増幅器からの仮想エネルギー出力。\n'
        '1500Wはアマチュア無線のFCC電力上限であり、4kWはExodus AMP20057の定格最大出力です。\n'
        '大都市圏の週間平均マイクロ波被曝量：約18ジュール。.22 LRライフル弾のマズルエネルギー：約200ジュール。',
    'power_recommended':            'パルスあたり16mJ推奨:',
...
'zh': {
    ...
    'power_last_action_count':      '上次TTS操作：',
    'power_calc_title':             '高功率计算器',
    'power_calc_summary':
        '基于当前脉冲宽度和脉冲计数，高功率微波放大器的假设能量输出。\n'
        '1500W是FCC业余无线电功率上限，4kW是Exodus AMP20057的额定最大输出。\n'
        '都市区平均每周微波暴露量：约18焦耳。.22 LR步枪子弹的枪口能量：约200焦耳。',
    'power_recommended':            '每脉冲建议16mJ：',
...
'ar': {
    ...
    'power_last_action_count':      'آخر إجراء TTS:',
    'power_calc_title':             'حاسبة الطاقة العالية',
    'power_calc_summary':
        'إخراج الطاقة الافتراضي من مضخم ميكروويف عالي الطاقة، للعرض الحالي للنبضة وعدد النبضات.\n'
        '1500 واط هو سقف الطاقة الخاص بلجنة الاتصالات الفيدرالية FCC للراديو الهاوي، و4 كيلوواط هو الحد الأقصى للطاقة الاسمية لجهاز Exodus AMP20057.\n'
        'متوسط التعرض الأسبوعي للميكروويف في المنطقة الحضرية: ~18 جول. طاقة الفوهة لطلقة بندقية .22 LR: ~200 جول.',
    'power_recommended':            'موصى به لـ 16 ميلي جول لكل نبضة:',
...
'bn': {
    ...
    'power_last_action_count':      'সর্বশেষ TTS অ্যাকশন:',
    'power_calc_title':             'হাই পাওয়ার ক্যালকুলেটর',
    'power_calc_summary':
        'বর্তমান পালস প্রস্থ এবং পালস গণনার জন্য, একটি উচ্চ-শক্তি মাইক্রোওয়েভ অ্যামপ্লিফায়ার থেকে অনুমানমূলক শক্তি আউটপুট।\n'
        '1500W হল FCC অপেশাদার রেডিও শক্তি সীমা, এবং 4kW হল Exodus AMP20057-এর রেটেড সর্বোচ্চ আউটপুট।\n'
        'মেট্রো এলাকার গড় সাপ্তাহিক মাইক্রোওয়েভ এক্সপোজার: ~১৮ জুল। .22 LR রাইফেল রাউন্ড থেকে মজল শক্তি: ~২০০ জুল।',
    'power_recommended':            'প্রতি পালস 16mJ-এর জন্য প্রস্তাবিত:',
...
'pt': {
    ...
    'power_last_action_count':      'Última ação TTS:',
    'power_calc_title':             'Calculadora de Alta Potência',
    'power_calc_summary':
        'Saída de energia hipotética de um amplificador de micro-ondas de alta potência, para a largura e contagem de pulsos atuais.\n'
        '1500W é o teto de potência da FCC para rádio amador, e 4kW é a saída máxima nominal do Exodus AMP20057.\n'
        'Exposição semanal média a micro-ondas em área metropolitana: ~18 joules. Energia na boca de um cartucho de rifle .22 LR: ~200 joules.',
    'power_recommended':            'Recomendado para 16mJ por pulso:',
...
'ur': {
    ...
    'power_last_action_count':      'آخری TTS ایکشن:',
    'power_calc_title':             'ہائی پاور کیلکولیٹر',
    'power_calc_summary':
        'موجودہ پلس چوڑائی اور پلس شمار کے لیے، ایک ہائی پاور مائیکرو ویو ایمپلیفائر سے فرضی توانائی کی پیداوار۔\n'
        '1500W FCC شوقیہ ریڈیو پاور کی حد ہے، اور 4kW Exodus AMP20057 کی درجہ بند زیادہ سے زیادہ پیداوار ہے۔\n'
        'میٹرو ایریا اوسط ہفتہ وار مائیکرو ویو نمائش: ~18 جولز۔ .22 LR رائفل راؤنڈ سے مزل توانائی: ~200 جولز۔',
    'power_recommended':            'فی پلس 16mJ کے لیے تجویز کردہ:',
...
'id': {
    ...
    'power_last_action_count':      'Tindakan TTS Terakhir:',
    'power_calc_title':             'Kalkulator Daya Tinggi',
    'power_calc_summary':
        'Keluaran energi hipotetis dari penguat gelombang mikro berdaya tinggi, untuk lebar pulsa dan hitungan pulsa saat ini.\n'
        '1500W adalah batas daya FCC untuk radio amatir, dan 4kW adalah keluaran maksimum terukur dari Exodus AMP20057.\n'
        'Paparan gelombang mikro mingguan rata-rata area metro: ~18 Joule. Energi moncong dari peluru senapan .22 LR: ~200 Joule.',
    'power_recommended':            'Direkomendasikan untuk 16mJ Per Pulsa:',
...
'ms': {
    ...
    'power_last_action_count':      'Tindakan TTS Terakhir:',
    'power_calc_title':             'Kalkulator Kuasa Tinggi',
    'power_calc_summary':
        'Output tenaga hipotesis daripada penguat gelombang mikro berkuasa tinggi, untuk lebar denyut dan kiraan denyut semasa.\n'
        '1500W ialah siling kuasa FCC untuk radio amatur, dan 4kW ialah output maksimum terkadar Exodus AMP20057.\n'
        'Pendedahan gelombang mikro mingguan purata kawasan metro: ~18 Joule. Tenaga muncung daripada peluru senapang .22 LR: ~200 Joule.',
    'power_recommended':            'Disyorkan untuk 16mJ Setiap Denyut:',
...
'sw': {
    ...
    'power_last_action_count':      'Kitendo cha Mwisho cha TTS:',
    'power_calc_title':             'Kikokotoo cha Nguvu Kubwa',
    'power_calc_summary':
        'Matokeo ya nishati ya kubuni kutoka kwa kikuza mawimbi ya microwave chenye nguvu kubwa, kwa upana wa mpigo na hesabu ya mipigo ya sasa.\n'
        '1500W ni kikomo cha nguvu cha FCC kwa redio ya amateur, na 4kW ni matokeo ya juu zaidi yaliyokadiriwa ya Exodus AMP20057.\n'
        'Wastani wa mfiduo wa microwave wa kila wiki katika eneo la metro: ~18 Joule. Nishati ya mdomo wa bunduki kutoka kwa risasi ya bunduki ya .22 LR: ~200 Joule.',
    'power_recommended':            'Inapendekezwa kwa 16mJ kwa Kila Mpigo:',
...
'tr': {
    ...
    'power_last_action_count':      'Son TTS Eylemi:',
    'power_calc_title':             'Yüksek Güç Hesaplayıcı',
    'power_calc_summary':
        'Mevcut darbe genişliği ve darbe sayısı için yüksek güçlü bir mikrodalga amplifikatörden varsayımsal enerji çıkışı.\n'
        '1500W amatör radyo için FCC güç tavanıdır ve 4kW Exodus AMP20057\'nin anma maksimum çıkışıdır.\n'
        'Metropol bölge haftalık ortalama mikrodalga maruziyeti: ~18 Jul. .22 LR tüfek mermisinden namlu enerjisi: ~200 Jul.',
    'power_recommended':            'Darbe Başına 16mJ İçin Önerilen:',
...
'vi': {
    ...
    'power_last_action_count':      'Hành Động TTS Cuối Cùng:',
    'power_calc_title':             'Máy Tính Công Suất Cao',
    'power_calc_summary':
        'Sản lượng năng lượng giả định từ một bộ khuếch đại vi sóng công suất cao, cho độ rộng xung và số lượng xung hiện tại.\n'
        '1500W là trần công suất FCC dành cho radio nghiệp dư, và 4kW là công suất đầu ra tối đa định mức của Exodus AMP20057.\n'
        'Mức phơi nhiễm vi sóng trung bình hàng tuần ở khu vực đô thị: ~18 Joule. Năng lượng đầu nòng từ một viên đạn súng trường .22 LR: ~200 Joule.',
    'power_recommended':            'Đề Xuất Cho 16mJ Mỗi Xung:',
...
'ko': {
    ...
    'power_last_action_count':      '마지막 TTS 작업:',
    'power_calc_title':             '고출력 계산기',
    'power_calc_summary':
        '현재 펄스 폭 및 펄스 수에 대한, 고출력 마이크로파 증폭기의 가상 에너지 출력.\n'
        '1500W는 아마추어 무선용 FCC 전력 상한이며, 4kW는 Exodus AMP20057의 정격 최대 출력입니다.\n'
        '대도시권 평균 주간 마이크로파 노출량: 약 18줄. .22 LR 소총탄의 총구 에너지: 약 200줄.',
    'power_recommended':            '펄스당 16mJ 권장:',
...
'fa': {
    ...
    'power_last_action_count':      'آخرین اقدام TTS:',
    'power_calc_title':             'ماشین‌حساب توان بالا',
    'power_calc_summary':
        'خروجی انرژی فرضی از یک تقویت‌کننده مایکروویو با توان بالا، برای عرض پالس و تعداد پالس فعلی.\n'
        '1500 وات سقف توان FCC برای رادیو آماتور است، و 4 کیلووات حداکثر خروجی نامی Exodus AMP20057 است.\n'
        'میانگین قرار گرفتن در معرض مایکروویو هفتگی در منطقه کلان‌شهری: ~18 ژول. انرژی دهانه از یک گلوله تفنگ .22 LR: ~200 ژول.',
    'power_recommended':            'توصیه‌شده برای 16 میلی‌ژول در هر پالس:',
...
'pa': {
    ...
    'power_last_action_count':      'ਆਖਰੀ TTS ਕਾਰਵਾਈ:',
    'power_calc_title':             'ਹਾਈ ਪਾਵਰ ਕੈਲਕੁਲੇਟਰ',
    'power_calc_summary':
        'ਮੌਜੂਦਾ ਪਲਸ ਚੌੜਾਈ ਅਤੇ ਪਲਸ ਗਿਣਤੀ ਲਈ, ਇੱਕ ਹਾਈ-ਪਾਵਰ ਮਾਈਕ੍ਰੋਵੇਵ ਐਂਪਲੀਫਾਇਰ ਤੋਂ ਕਾਲਪਨਿਕ ਊਰਜਾ ਆਉਟਪੁੱਟ।\n'
        '1500W FCC ਸ਼ੌਕੀਆ ਰੇਡੀਓ ਪਾਵਰ ਸੀਮਾ ਹੈ, ਅਤੇ 4kW Exodus AMP20057 ਦਾ ਦਰਜਾ ਪ੍ਰਾਪਤ ਵੱਧ ਤੋਂ ਵੱਧ ਆਉਟਪੁੱਟ ਹੈ।\n'
        'ਮੈਟਰੋ ਖੇਤਰ ਔਸਤ ਹਫ਼ਤਾਵਾਰੀ ਮਾਈਕ੍ਰੋਵੇਵ ਐਕਸਪੋਜ਼ਰ: ~18 ਜੂਲ। .22 LR ਰਾਈਫਲ ਰਾਊਂਡ ਤੋਂ ਮਜ਼ਲ ਊਰਜਾ: ~200 ਜੂਲ।',
    'power_recommended':            'ਪ੍ਰਤੀ ਪਲਸ 16mJ ਲਈ ਸਿਫ਼ਾਰਸ਼ੀ:',
...
'te': {
    ...
    'power_last_action_count':      'చివరి TTS చర్య:',
    'power_calc_title':             'హై పవర్ కాలిక్యులేటర్',
    'power_calc_summary':
        'ప్రస్తుత పల్స్ వెడల్పు మరియు పల్స్ గణన కోసం, అధిక-శక్తి మైక్రోవేవ్ యాంప్లిఫైయర్ నుండి ఊహాత్మక శక్తి అవుట్‌పుట్.\n'
        '1500W అనేది అమెచ్యూర్ రేడియో కోసం FCC శక్తి పరిమితి, మరియు 4kW అనేది Exodus AMP20057 యొక్క రేటెడ్ గరిష్ట అవుట్‌పుట్.\n'
        'మెట్రో ప్రాంతం సగటు వారపు మైక్రోవేవ్ ఎక్స్‌పోజర్: ~18 జూల్స్. .22 LR రైఫిల్ రౌండ్ నుండి మజిల్ శక్తి: ~200 జూల్స్.',
    'power_recommended':            'పల్స్‌కు 16mJ కోసం సిఫార్సు చేయబడింది:',
...
'mr': {
    ...
    'power_last_action_count':      'शेवटची TTS क्रिया:',
    'power_calc_title':             'हाय पॉवर कॅल्क्युलेटर',
    'power_calc_summary':
        'सध्याच्या पल्स रुंदी आणि पल्स संख्येसाठी, उच्च-शक्ती मायक्रोवेव्ह अॅम्प्लिफायरमधून काल्पनिक ऊर्जा उत्पादन.\n'
        '1500W ही हौशी रेडिओसाठी FCC शक्ती मर्यादा आहे, आणि 4kW हे Exodus AMP20057 चे रेट केलेले कमाल आउटपुट आहे.\n'
        'मेट्रो क्षेत्र सरासरी साप्ताहिक मायक्रोवेव्ह एक्सपोजर: ~18 ज्युल्स. .22 LR रायफल राउंडमधून मझल ऊर्जा: ~200 ज्युल्स.',
    'power_recommended':            'प्रति पल्स 16mJ साठी शिफारस केलेले:',
...
'ta': {
    ...
    'power_last_action_count':      'கடைசி TTS செயல்:',
    'power_calc_title':             'உயர் திறன் கால்குலேட்டர்',
    'power_calc_summary':
        'தற்போதைய துடிப்பு அகலம் மற்றும் துடிப்பு எண்ணிக்கைக்கான, உயர்-திறன் மைக்ரோவேவ் ஆம்ப்ளிஃபையரிலிருந்து கருதுகோள் ஆற்றல் வெளியீடு.\n'
        '1500W என்பது அமெச்சூர் ரேடியோவிற்கான FCC திறன் உச்சவரம்பு ஆகும், மற்றும் 4kW என்பது Exodus AMP20057 இன் மதிப்பிடப்பட்ட அதிகபட்ச வெளியீடு ஆகும்.\n'
        'மெட்ரோ பகுதி சராசரி வாராந்திர மைக்ரோவேவ் வெளிப்பாடு: ~18 ஜூல்கள். .22 LR துப்பாக்கி ரவுண்டிலிருந்து முகவாய் ஆற்றல்: ~200 ஜூல்கள்.',
    'power_recommended':            'ஒரு துடிப்புக்கு 16mJ க்கு பரிந்துரைக்கப்படுகிறது:',
...
'pl': {
    ...
    'power_last_action_count':      'Ostatnia akcja TTS:',
    'power_calc_title':             'Kalkulator dużej mocy',
    'power_calc_summary':
        'Hipotetyczna moc wyjściowa z wysokiej mocy wzmacniacza mikrofalowego, dla bieżącej szerokości i liczby impulsów.\n'
        '1500W to limit mocy FCC dla radia amatorskiego, a 4kW to znamionowa maksymalna moc wyjściowa Exodus AMP20057.\n'
        'Średnie tygodniowe narażenie na mikrofale w obszarze metropolitalnym: ~18 dżuli. Energia wylotowa naboju karabinowego .22 LR: ~200 dżuli.',
    'power_recommended':            'Zalecane dla 16mJ na impuls:',
...
'ro': {
    ...
    'power_last_action_count':      'Ultima acțiune TTS:',
    'power_calc_title':             'Calculator de putere mare',
    'power_calc_summary':
        'Ieșire ipotetică de energie de la un amplificator de microunde de mare putere, pentru lățimea și numărul curent de impulsuri.\n'
        '1500W este plafonul de putere FCC pentru radioamatori, iar 4kW este puterea maximă nominală a Exodus AMP20057.\n'
        'Expunerea săptămânală medie la microunde în zona metropolitană: ~18 jouli. Energia la gura țevii a unui cartuș de pușcă .22 LR: ~200 jouli.',
    'power_recommended':            'Recomandat pentru 16mJ pe impuls:',
...
'nl': {
    ...
    'power_last_action_count':      'Laatste TTS-actie:',
    'power_calc_title':             'Hoogvermogen-calculator',
    'power_calc_summary':
        'Hypothetische energie-uitvoer van een hoogvermogen microgolfversterker, voor de huidige pulsbreedte en pulstelling.\n'
        '1500W is het FCC-vermogensplafond voor amateurradio, en 4kW is het nominale maximale uitgangsvermogen van de Exodus AMP20057.\n'
        'Gemiddelde wekelijkse microgolfblootstelling in grootstedelijk gebied: ~18 joule. Mondingsenergie van een .22 LR-geweerpatroon: ~200 joule.',
    'power_recommended':            'Aanbevolen voor 16mJ per puls:',
...
'hu': {
    ...
    'power_last_action_count':      'Utolsó TTS-művelet:',
    'power_calc_title':             'Nagyteljesítményű számológép',
    'power_calc_summary':
        'Hipotetikus energiakimenet egy nagyteljesítményű mikrohullámú erősítőből, a jelenlegi impulzusszélességre és impulzusszámra vonatkozóan.\n'
        'Az 1500W az FCC teljesítményplafonja amatőr rádióhoz, a 4kW pedig az Exodus AMP20057 névleges maximális kimenete.\n'
        'Átlagos heti mikrohullámú expozíció nagyvárosi térségben: ~18 Joule. Torkolati energia egy .22 LR puskalövedékből: ~200 Joule.',
    'power_recommended':            'Ajánlott 16mJ impulzusonként:',
...
'el': {
    ...
    'power_last_action_count':      'Τελευταία ενέργεια TTS:',
    'power_calc_title':             'Υπολογιστής Υψηλής Ισχύος',
    'power_calc_summary':
        'Υποθετική ενεργειακή έξοδος από έναν ενισχυτή μικροκυμάτων υψηλής ισχύος, για το τρέχον πλάτος και πλήθος παλμών.\n'
        'Τα 1500W είναι το ανώτατο όριο ισχύος της FCC για ερασιτεχνικό ραδιόφωνο, και τα 4kW είναι η ονομαστική μέγιστη έξοδος του Exodus AMP20057.\n'
        'Μέση εβδομαδιαία έκθεση σε μικροκύματα σε μητροπολιτική περιοχή: ~18 τζάουλ. Ενέργεια στόμιου από φυσίγγιο τουφεκιού .22 LR: ~200 τζάουλ.',
    'power_recommended':            'Συνιστάται για 16mJ ανά παλμό:',
...
'cs': {
    ...
    'power_last_action_count':      'Poslední akce TTS:',
    'power_calc_title':             'Kalkulačka vysokého výkonu',
    'power_calc_summary':
        'Hypotetický energetický výstup z vysoce výkonného mikrovlnného zesilovače, pro aktuální šířku a počet pulzů.\n'
        '1500W je výkonový strop FCC pro amatérské rádio, a 4kW je jmenovitý maximální výstup Exodus AMP20057.\n'
        'Průměrná týdenní expozice mikrovlnám v metropolitní oblasti: ~18 joulů. Ústí energie z náboje pušky .22 LR: ~200 joulů.',
    'power_recommended':            'Doporučeno pro 16mJ na pulz:',
...
'hr': {
    ...
    'power_last_action_count':      'Posljednja TTS radnja:',
    'power_calc_title':             'Kalkulator velike snage',
    'power_calc_summary':
        'Hipotetski energetski izlaz iz visokosnažnog mikrovalnog pojačala, za trenutnu širinu i broj impulsa.\n'
        '1500W je FCC gornja granica snage za amatersko radio, a 4kW je nazivni maksimalni izlaz uređaja Exodus AMP20057.\n'
        'Prosječna tjedna izloženost mikrovalovima u metropolitanskom području: ~18 džula. Energija na ustima cijevi metka .22 LR: ~200 džula.',
    'power_recommended':            'Preporučeno za 16mJ po impulsu:',
...
'lt': {
    ...
    'power_last_action_count':      'Paskutinis TTS veiksmas:',
    'power_calc_title':             'Didelės galios skaičiuoklė',
    'power_calc_summary':
        'Hipotetinė energijos išeiga iš didelės galios mikrobangų stiprintuvo, esamam impulso pločiui ir impulsų skaičiui.\n'
        '1500W yra FCC galios riba mėgėjų radijui, o 4kW yra nominali didžiausia „Exodus AMP20057“ išeiga.\n'
        'Vidutinis savaitinis mikrobangų poveikis metropolijos zonoje: ~18 džaulių. Snukio energija iš .22 LR šautuvo šovinio: ~200 džaulių.',
    'power_recommended':            'Rekomenduojama 16mJ vienam impulsui:',
...
'uk': {
    ...
    'power_last_action_count':      'Остання дія TTS:',
    'power_calc_title':             'Калькулятор високої потужності',
    'power_calc_summary':
        'Гіпотетична вихідна енергія від потужного мікрохвильового підсилювача, для поточної ширини та кількості імпульсів.\n'
        '1500 Вт — це стеля потужності FCC для аматорського радіо, а 4 кВт — номінальна максимальна вихідна потужність Exodus AMP20057.\n'
        'Середнє щотижневе мікрохвильове опромінення в мегаполісі: ~18 джоулів. Дульна енергія патрона гвинтівки .22 LR: ~200 джоулів.',
    'power_recommended':            'Рекомендовано для 16мДж на імпульс:',
...
'ca': {
    ...
    'power_last_action_count':      'Última acció TTS:',
    'power_calc_title':             'Calculadora d\'alta potència',
    'power_calc_summary':
        'Sortida d\'energia hipotètica d\'un amplificador de microones d\'alta potència, per a l\'amplada i el recompte de polsos actuals.\n'
        '1500W és el sostre de potència de la FCC per a ràdio amateur, i 4kW és la sortida màxima nominal de l\'Exodus AMP20057.\n'
        'Exposició setmanal mitjana a microones en àrea metropolitana: ~18 joules. Energia a la boca d\'un cartutx de rifle .22 LR: ~200 joules.',
    'power_recommended':            'Recomanat per a 16mJ per pols:',
...
'fi': {
    ...
    'power_last_action_count':      'Viimeisin TTS-toiminto:',
    'power_calc_title':             'Suuritehoinen laskin',
    'power_calc_summary':
        'Hypoteettinen energiantuotto suuritehoisesta mikroaaltovahvistimesta, nykyiselle pulssin leveydelle ja pulssimäärälle.\n'
        '1500W on FCC:n tehokatto amatööriradiolle, ja 4kW on Exodus AMP20057:n nimellinen maksimiteho.\n'
        'Metropolialueen keskimääräinen viikoittainen mikroaaltoaltistus: ~18 Joulea. Suuenergia .22 LR -kivääripatruunasta: ~200 Joulea.',
    'power_recommended':            'Suositeltu 16mJ per pulssi:',
...
'bg': {
    ...
    'power_last_action_count':      'Последно TTS действие:',
    'power_calc_title':             'Калкулатор за висока мощност',
    'power_calc_summary':
        'Хипотетична енергийна мощност от усилвател на микровълни с висока мощност, за текущата ширина на импулса и броя импулси.\n'
        '1500W е таванът на мощността на FCC за любителско радио, а 4kW е номиналната максимална мощност на Exodus AMP20057.\n'
        'Средна седмична експозиция на микровълни в градска зона: ~18 джаула. Дулна енергия от патрон за пушка .22 LR: ~200 джаула.',
    'power_recommended':            'Препоръчително за 16mJ на импулс:',
...
'sr': {
    ...
    'power_last_action_count':      'Последња TTS радња:',
    'power_calc_title':             'Калкулатор велике снаге',
    'power_calc_summary':
        'Хипотетички енергетски излаз из микроталасног појачала велике снаге, за тренутну ширину и број импулса.\n'
        '1500W је FCC горња граница снаге за аматерски радио, а 4kW је номинални максимални излаз уређаја Exodus AMP20057.\n'
        'Просечна недељна изложеност микроталасима у метрополитанском подручју: ~18 џула. Енергија на устима цеви метка .22 LR: ~200 џула.',
    'power_recommended':            'Препоручено за 16mJ по импулсу:',
...
'bs': {
    ...
    'power_calc_title':             'Kalkulator velike snage',
    'power_calc_summary':
        'Hipotetski energetski izlaz iz mikrotalasnog pojačala velike snage, za trenutnu širinu i broj impulsa.\n'
        '1500W je FCC gornja granica snage za amatersko radio, a 4kW je nazivni maksimalni izlaz uređaja Exodus AMP20057.\n'
        'Prosječna sedmična izloženost mikrotalasima u metropolitanskom području: ~18 džula. Energija na ustima cijevi metka .22 LR: ~200 džula.',
    'power_recommended':            'Preporučeno za 16mJ po impulsu:',
    'power_per_pulse':              'Snaga po impulsu:',
    'col_signal_conditioning':    'Kondicioniranje signala',
    'col_noise_silence':          'Šum / Tišina',
...
'da': {
    ...
    'power_last_action_count':      'Seneste TTS-handling:',
    'power_calc_title':             'Højeffektberegner',
    'power_calc_summary':
        'Hypotetisk energiudgang fra en højeffekts mikrobølgeforstærker, for den aktuelle pulsbredde og pulsantal.\n'
        '1500W er FCC\'s effektloft for amatørradio, og 4kW er den nominelle maksimale udgangseffekt for Exodus AMP20057.\n'
        'Gennemsnitlig ugentlig mikrobølgeeksponering i storbyområde: ~18 Joule. Mundingsenergi fra en .22 LR-riffelpatron: ~200 Joule.',
    'power_recommended':            'Anbefalet til 16mJ pr. puls:',
...
'sk': {
    ...
    'power_total_energy':           'Celkový energetický výstup:',
    'power_last_action_count':      'Posledná akcia TTS:',
    'power_calc_title':             'Kalkulačka vysokého výkonu',
    'power_calc_summary':
        'Hypotetický energetický výstup z vysoko výkonného mikrovlnného zosilňovača, pre aktuálnu šírku a počet impulzov.\n'
        '1500W je výkonový strop FCC pre amatérske rádio, a 4kW je menovitý maximálny výstup Exodus AMP20057.\n'
        'Priemerná týždenná expozícia mikrovlnám v metropolitnej oblasti: ~18 joulov. Ústie energie z náboja pušky .22 LR: ~200 joulov.',
    'power_recommended':            'Odporúčané pre 16mJ na impulz:',
...
'be': {
    ...
    'power_last_action_count':      'Апошняе дзеянне TTS:',
    'power_calc_title':             'Калькулятар высокай магутнасці',
    'power_calc_summary':
        'Гіпатэтычная выходная энергія ад магутнага мікрахвалевага ўзмацняльніка, для бягучай шырыні і колькасці імпульсаў.\n'
        '1500 Вт — гэта столь магутнасці FCC для аматарскага радыё, а 4 кВт — намінальная максімальная выхадная магутнасць Exodus AMP20057.\n'
        'Сярэдняе штотыднёвае мікрахвалевае апрамяненне ў мегаполісе: ~18 джоўляў. Дульная энергія патрона вінтоўкі .22 LR: ~200 джоўляў.',
    'power_recommended':            'Рэкамендавана для 16мДж на імпульс:',
...
'et': {
    ...
    'power_last_action_count':      'Viimane TTS-toiming:',
    'power_calc_title':             'Suure võimsuse kalkulaator',
    'power_calc_summary':
        'Hüpoteetiline energiaväljund suure võimsusega mikrolaineahvistist, praeguse impulsi laiuse ja impulsside arvu jaoks.\n'
        '1500W on FCC võimsuse ülempiir harrastusraadiole ja 4kW on Exodus AMP20057 nimivõimsuse maksimaalne väljund.\n'
        'Keskmine iganädalane mikrolaineekspositsioon suurlinnapiirkonnas: ~18 džauli. Suudmeenergia .22 LR vintpüssipadrunist: ~200 džauli.',
    'power_recommended':            'Soovitatud 16mJ impulsi kohta:',
...
'is': {
    ...
    'power_last_action_count':      'Síðasta TTS aðgerð:',
    'power_calc_title':             'Aflmikill reiknivél',
    'power_calc_summary':
        'Ímyndað orkuúttak frá aflmiklum örbylgjumagnara, fyrir núverandi púlsbreidd og púlsafjölda.\n'
        '1500W er aflþak FCC fyrir áhugamannaútvarp, og 4kW er nafnhámarksafköst Exodus AMP20057.\n'
        'Meðal vikuleg örbylgjuáhrif á stórborgarsvæði: ~18 júl. Hlaupsorka úr .22 LR riffilskoti: ~200 júl.',
    'power_recommended':            'Mælt með fyrir 16mJ á púls:',
...
'lv': {
    ...
    'power_last_action_count':      'Pēdējā TTS darbība:',
    'power_calc_title':             'Lielas jaudas kalkulators',
    'power_calc_summary':
        'Hipotētiska enerģijas izvade no liela jaudas mikroviļņu pastiprinātāja, pašreizējam impulsa platumam un impulsu skaitam.\n'
        '1500W ir FCC jaudas griesti radioamatieriem, un 4kW ir Exodus AMP20057 nominālā maksimālā izvade.\n'
        'Vidējā iknedēļas mikroviļņu iedarbība metropoles zonā: ~18 džoulu. Stobra enerģija no .22 LR šautenes patronas: ~200 džoulu.',
    'power_recommended':            'Ieteicams 16mJ uz impulsu:',
...
'lb': {
    ...
    'power_last_action_count':      'Lescht TTS-Aktioun:',
    'power_calc_title':             'Héichleistungsrechner',
    'power_calc_summary':
        'Hypothetesch Energieausgang vun engem Héichleistungs-Mikrowellenverstärker, fir déi aktuell Impulsbreet an Impulszuel.\n'
        '1500W ass déi FCC Leeschtungsuewergrenz fir Amateurfunk, an 4kW ass déi nominal maximal Ausgangsleeschtung vum Exodus AMP20057.\n'
        'Duerchschnëttlech wéchentlech Mikrowelle-Expositioun am Metropolberäich: ~18 Joule. Mündungsenergie vun enger .22 LR Gewierpatroun: ~200 Joule.',
    'power_recommended':            'Empfohlen fir 16mJ pro Impuls:',
...
'mn': {
    ...
    'power_last_action_count':      'Сүүлийн TTS үйлдэл:',
    'power_calc_title':             'Өндөр Чадлын Тооцоологч',
    'power_calc_summary':
        'Одоогийн импульсийн өргөн болон импульсийн тооны хувьд, өндөр чадалтай микротолгойт өсгөгчийн таамаглалын энергийн гаралт.\n'
        '1500W нь сонирхогчийн радиогийн FCC чадлын дээд хязгаар бөгөөд 4kW нь Exodus AMP20057-ийн тохируулсан дээд гаралт юм.\n'
        'Метро бүсийн долоо хоног тутмын дундаж микротолгойт цацрагийн өртөлт: ~18 Джоуль. .22 LR буудлын сумнаас амны энерги: ~200 Джоуль.',
    'power_recommended':            'Импульс тутамд 16mJ-д зөвлөж байна:',
...
'mi': {
    ...
    'power_last_action_count':      'Mahi TTS Whakamutunga:',
    'power_calc_title':             'Kaitātau Kaha Nui',
    'power_calc_summary':
        'Putanga kaha whakaaro mō te whānuitanga whiu me te tatau whiu o nāianei, mai i te kaiwhakanui hikohiko waena-roa kaha nui.\n'
        'Ko te 1500W te tiketike kaha FCC mō te reo irirangi ngākau nui, ā, ko te 4kW te putanga tino nui kua whakaritea o te Exodus AMP20057.\n'
        'Toharite whakaaweawe waena-roa ā-wiki o te rohe taone nui: ~18 Huka. Kaha waha pū mai i te karihi pū .22 LR: ~200 Huka.',
    'power_recommended':            'E tūtohutia ana mō te 16mJ ia Whiu:',
...
class SwapPanel(QtWidgets.QWidget):
    """
    A panel that can show a grey overlay when 'inactive' (used for the
    Mic/eSpeak input-source swap panels and the TX/Save output panels,
    which sit side by side in pairs with a SwapButton widget between them
    at the shared divider).

    Uses solid, fully-opaque colours throughout -- interpolating directly
    between disabled-grey and background-white -- rather than alpha
    transparency.  An earlier alpha-based version painted a fully-opaque
    base fill first and then tried to blend semi-transparent overlays on
    top of it; blending a "more transparent" colour over an already-opaque
    layer has no visible effect (there's nothing beneath for it to
    reveal), which silently broke both the edge gradient and the top/
    bottom feather.  Solid RGB interpolation has no such compositing
    ambiguity -- each pixel's final colour is computed directly.

    Two treatments, both only drawn while dimmed:

    - Top/bottom edges: a tight N-pixel step gradient (nested 1px-tall
      strips, each closer to full grey than the last as you move inward).

    - A vertical band behind the SwapButton (set via divider_side): MOST
      of the panel stays solid, uniform grey.  Only a band near the edge
      facing the button transitions toward background colour, and that
      transition's "reaches background" endpoint is placed PAST the
      panel's own boundary, roughly at the SwapButton's own centre line
      (though nothing is actually drawn out there -- a widget can't paint
      outside its own geometry).  The panel's own edge pixel is therefore
      only partway transitioned, so the band reads as continuing on
      behind the button rather than hard-stopping at the boundary.
    """
    _TRANSITION_W = 30    # how far INTO the panel the band extends,
                          # measured from the edge nearest the button
    _BUTTON_HALF_W = 22   # SwapButton.W // 2 -- how far PAST the panel's
                          # edge the "reaches background" point sits
                          # (conceptually, at the button's own centre line)
    _BG_COLOR = QtGui.QColor("#FFFFFF")   # background colour to fade toward

    def __init__(self, parent=None, divider_side='right'):
        super().__init__(parent)
        self._dim_active = False
        self._dim_color = QtGui.QColor("#b8b8b8")
        self._feather_px = 5       # top/bottom tight feather width
        self._divider_side = divider_side   # 'left' or 'right' --
                                             # which edge of THIS panel
                                             # faces its SwapButton
    ...
    def _lerp_color(c1, c2, t):
        """Solid RGB interpolation, t=0 -> c1, t=1 -> c2."""
        return QtGui.QColor(
    ...
    def paintEvent(self, event):
        if self._dim_active:
            ...
            # Solid grey fill everywhere first -- most of the panel has no
            # gradient at all.  Fully opaque, so later solid-colour draws
            # cleanly overwrite it with no blending ambiguity.
            p.fillRect(r, c)

            # Vertical band behind the SwapButton: solid gradient from
            # grey to background colour (no alpha involved).
            grad = QtGui.QLinearGradient()
            if self._divider_side == 'right':
                fade_start_x = r.right() - self._TRANSITION_W
                fade_end_x   = r.right() + self._BUTTON_HALF_W
                band_rect = QtCore.QRect(
                    fade_start_x, r.top(), r.right() - fade_start_x + 1, r.height())
            else:
                fade_start_x = r.left() + self._TRANSITION_W
                fade_end_x   = r.left() - self._BUTTON_HALF_W
                band_rect = QtCore.QRect(
                    r.left(), r.top(), fade_start_x - r.left() + 1, r.height())
            grad.setStart(fade_start_x, 0)
            grad.setFinalStop(fade_end_x, 0)
            grad.setColorAt(0.0, c)
            grad.setColorAt(1.0, bg)
            p.fillRect(band_rect, grad)

            # Tight top/bottom feather -- solid interpolated colours, safe
            # now that everything is fully opaque (no compositing issue).
            p.setPen(QtCore.Qt.NoPen)
            n = self._feather_px
            for i in range(n):
                t = (i + 1) / float(n)   # i=0 (at edge) -> mostly bg;
                                         # i=n-1 (innermost) -> mostly grey
                col = self._lerp_color(bg, c, t)
                p.setBrush(col)
                p.drawRect(QtCore.QRect(r.left(), r.top() + i, r.width(), 1))
                p.drawRect(QtCore.QRect(r.left(), r.bottom() - i, r.width(), 1))
...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    # Directional horn/waveguide antenna gain used in the 50cm/1m EIRP
    # power-density calculation (see _update_power_calc).  20 dBi models a
    # moderately-sized horn at 425MHz/1300MHz -- change this to model a
    # different antenna.
    _HORN_GAIN_DBI     = 20.0
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/8/14 - Version 113)")
    ...
    def _build_gui(self):
        ...
        es_vbox.addSpacing(20)
        audio_row.addWidget(self._es_panel, 1)
        vbox.addLayout(audio_row)
        vbox.addSpacing(2)   # trimmed -- most of this space moved INTO the
                             # panels' own trailing height below, so the
                             # disabled-grey rectangle can actually cover it
                             # (a widget can't paint space outside its own
                             # geometry, so external spacing here would
                             # always show as an uncovered gap)
        ...
        self._power_reset_btn.setFixedWidth(70)   # 60% wider (44 -> 70)
    ...
    def _update_power_calc(self):
        ...
        # "Point Blank" is the raw target-energy/pulse-duration figure
        # above -- power delivered with no free-space spreading loss (no
        # meaningful far-field pattern at essentially zero range, so
        # antenna gain doesn't apply here).
        #
        # 50cm/1m use the EIRP power-density formula for a DIRECTIONAL
        # antenna: S(r) = P_t*G / (4*pi*r^2), rearranged to solve for the
        # transmitter power needed to reproduce the target power density
        # at distance r: P_t(r) = S * 4*pi*r^2 / G.
        #
        # _HORN_GAIN_DBI = 20 dBi (100x linear) models a moderately-sized
        # horn/waveguide antenna -- realistic for a horn at these UHF/
        # L-band frequencies (425MHz/1300MHz), where aperture size (and
        # therefore achievable gain) scales with wavelength.  A directional
        # antenna concentrates the same total power into a narrower beam,
        # so far less transmitter power is needed for the same power
        # density on-axis vs. an isotropic radiator (previous model).
        # Still illustrative, not an engineering figure -- change
        # _HORN_GAIN_DBI to model a different antenna.
        gain_linear = 10.0 ** (self._HORN_GAIN_DBI / 10.0)
        p_50cm = (p_point_blank * 4.0 * math.pi * (0.5 ** 2)) / gain_linear
        p_1m   = (p_point_blank * 4.0 * math.pi * (1.0 ** 2)) / gain_linear
        self._power_recommended_lbl.setText(
            "{} {:.0f}W (Point Blank),    {:.2f}W (50cm),    {:.2f}W (1m)".format(

...
# packages.  Belarusian, Latvian, Luxembourgish, Mongolian, and Maori have
# no widely-packaged MBROLA voice despite thorough checking -- also note
# MBROLA's 'nz1' is New Zealand-accented ENGLISH, not Maori, so it is
# correctly NOT mapped to 'mi' (same naming-trap pattern as sw1/2 and ca1/2).
_MBROLA_VOICE_MAP = {
    'en': 'en1',
    'de': 'de6',
    'fr': 'fr4',
...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/8/12 - Version 80)")
    ...
    def _build_gui(self):
        ...
        # Cap the combobox to the button's own compact width so the language
        # picker never dominates the column with a long language name --
        # e.g. "Bahasa Indonesia  (Indonesian)" would otherwise force this
        # whole column much wider than "Event Log" ever needs to be.
        self._lang_combo.setMaximumWidth(self._log_btn.sizeHint().width())

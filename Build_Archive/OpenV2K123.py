...
'de': {
    ...
    'waterfall_checkbox':          'Spektrogramm-Bild erzeugen',
...
'fr': {
    ...
    'waterfall_checkbox':          'Générer l\'image du spectrogramme',
...
'es': {
    ...
    'record_iq':                   'Grabar IQ',
    'recording':                   'Grabando...',
    'waterfall_checkbox':          'Generar imagen de espectrograma',
...
'it': {
    ...
    'waterfall_checkbox':          'Genera immagine dello spettrogramma',
...
'sv': {
    ...
    'recording':                   'Spelar in...',
    'waterfall_checkbox':          'Generera spektrogrambild',
...
'no': {
    ...
    'record_iq':                   'Ta opp IQ',
    'recording':                   'Tar opp...',
    'waterfall_checkbox':          'Generer spektrogrambilde',
...
'ru': {
    ...
    'recording':                   'Запись...',
    'waterfall_checkbox':          'Создать изображение спектрограммы',
...
'hi': {
    ...
    'waterfall_checkbox':          'स्पेक्ट्रोग्राम छवि बनाएं',
    'event_log':                   'इवेंट लॉग',
...
'ja': {
    ...
    'record_iq':                   'IQを録音',
    'recording':                   '録音中...',
    'waterfall_checkbox':          'スペクトログラム画像を生成',
    'event_log':                   'イベントログ',
...
'ar': {
    ...
    'waterfall_checkbox':          'إنشاء مخطط طيفي',
...
'bn': {
    ...
    'waterfall_checkbox':          'স্পেক্ট্রোগ্রাম ছবি তৈরি করুন',
    'event_log':                  'ইভেন্ট লগ',
...
'pt': {
    ...
    'record_iq':                   'Gravar IQ',
    'recording':                   'A gravar...',
    'waterfall_checkbox':          'Gerar imagem de espectrograma',
...
'ur': {
    ...
    'waterfall_checkbox':          'سپیکٹروگرام تصویر بنائیں',
    'event_log':                   'ایونٹ لاگ',
...
'id': {
    ...
    'record_iq':                   'Rekam IQ',
    'recording':                   'Merekam...',
    'waterfall_checkbox':          'Buat gambar spektrogram',
...
'ms': {
    ...
    'record_iq':                   'Rakam IQ',
    'recording':                   'Merakam...',
    'waterfall_checkbox':          'Jana imej spektrogram',
    'event_log':                   'Log Peristiwa',
    'event_log_title':             '  OpenV2K  Log Peristiwa',
    'no_mbrola_voice':
...
'sw': {
    ...
    'record_iq':                   'Rekodi IQ',
    'recording':                   'Inarekodi...',
    'waterfall_checkbox':          'Tengeneza picha ya spectrogram',
...
'tr': {
    ...
    'waterfall_checkbox':          'Spektrogram görüntüsü oluştur',
...
'vi': {
    ...
    'record_iq':                   'Ghi IQ',
    'recording':                   'Đang ghi...',
    'waterfall_checkbox':          'Tạo hình ảnh phổ đồ',
...
'ko': {
    ...
    'record_iq':                   'IQ 녹음',
    'recording':                   '녹음 중...',
    'waterfall_checkbox':          '스펙트로그램 이미지 생성',
    'event_log':                   '이벤트 로그',
...
'fa': {
    ...
    'waterfall_checkbox':          'ایجاد تصویر طیف‌نگاشت',
...
'pa': {
    ...
    'waterfall_checkbox':          'ਸਪੈਕਟਰੋਗ੍ਰਾਮ ਚਿੱਤਰ ਬਣਾਓ',
    'event_log':                   'ਇਵੈਂਟ ਲੌਗ',
...
'te': {
    ...
    'waterfall_checkbox':          'స్పెక్ట్రోగ్రామ్ చిత్రాన్ని సృష్టించండి',
...
'mr': {
    ...
    'waterfall_checkbox':          'स्पेक्ट्रोग्राम प्रतिमा तयार करा',
...
'ta': {
    ...
    'waterfall_checkbox':          'ஸ்பெக்ட்ரோகிராம் படத்தை உருவாக்கு',
...
'pl': {
    ...
    'waterfall_checkbox':          'Generuj obraz spektrogramu',
...
'ro': {
    ...
    'waterfall_checkbox':          'Generează imagine spectrogramă',
...
'nl': {
    ...
    'waterfall_checkbox':          'Spectrogram-afbeelding genereren',
...
'hu': {
    ...
    'recording':                   'Felvétel...',
    'waterfall_checkbox':          'Spektrogram kép generálása',
...
'el': {
    ...
    'waterfall_checkbox':          'Δημιουργία εικόνας φασματογραφήματος',
...
'cs': {
    ...
    'record_iq':                   'Nahrát IQ',
    'recording':                   'Nahrávání...',
    'waterfall_checkbox':          'Vygenerovat obrázek spektrogramu',
...
'hr': {
    ...
    'record_iq':                   'Snimi IQ',
    'recording':                   'Snimanje...',
    'waterfall_checkbox':          'Generiraj sliku spektrograma',
...
'lt': {
    ...
    'recording':                   'Įrašoma...',
    'waterfall_checkbox':          'Generuoti spektrogramos vaizdą',
...
'uk': {
    ...
    'recording':                   'Запис...',
    'waterfall_checkbox':          'Створити зображення спектрограми',
...
'ca': {
    ...
    'waterfall_checkbox':          'Genera imatge d\'espectrograma',
...
'fi': {
    ...
    'waterfall_checkbox':          'Luo spektrogrammikuva',
...
'bg': {
    ...
    'waterfall_checkbox':          'Генерирай изображение на спектрограма',
...
'sr': {
    ...
    'record_iq':                   'Сними IQ',
    'recording':                   'Снимање...',
    'waterfall_checkbox':          'Генериши слику спектрограма',
...
'bs': {
    ...
    'record_iq':                   'Snimi IQ',
    'recording':                   'Snimanje...',
    'waterfall_checkbox':          'Generiši sliku spektrograma',
...
'da': {
    ...
    'record_iq':                   'Optag IQ',
    'recording':                   'Optager...',
    'waterfall_checkbox':          'Generer spektrogrambillede',
...
'sk': {
    ...
    'waterfall_checkbox':          'Vygenerovať obrázok spektrogramu',
...
'be': {
    ...
    'recording':                   'Запіс...',
    'waterfall_checkbox':          'Стварыць малюнак спектраграмы',
...
'et': {
    ...
    'waterfall_checkbox':          'Loo spektrogrammi pilt',
...
'is': {
    ...
    'recording':                   'Tek upp...',
    'waterfall_checkbox':          'Búa til litrófsmynd',
...
'lv': {
    ...
    'recording':                   'Ieraksta...',
    'waterfall_checkbox':          'Ģenerēt spektrogrammas attēlu',
...
'lb': {
    ...
    'waterfall_checkbox':          'Spektrogramm-Bild generéieren',
...
'mn': {
    ...
    'waterfall_checkbox':          'Спектрограммын зураг үүсгэх',
...
'mi': {
    ...
    'waterfall_checkbox':          'Hanga whakaahua kōwhitiwhiti',
...
class SegmentedMeter(QtWidgets.QWidget):
    ...
    def paintEvent(self, event):
        ...
        n = self._n
        gap = 2
        seg_h = r.height() / float(n)
        lit = int(round((self._value / self._max) * n)) if self._max > 0 else 0
        p.setPen(QtCore.Qt.NoPen)
        for i in range(n):
            seg_num = i + 1
            top = r.bottom() - seg_num * seg_h
            seg_rect = QtCore.QRectF(r.left(), top, r.width(), seg_h - gap)
...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/8/14 - Version 123)")
    ...
    def _build_gui(self):
        ...
        # Live and Peak meters side by side.  Live keeps its existing
        # numeric readout; Peak gets its own new one.  Both meters use
        # SegmentedMeter (see class above) instead of QProgressBar, which
        # fixes a real bug where the old gradient's colour stops were
        # scoped to the filled chunk's own geometry rather than the
        # bar's absolute value range -- meaning even a low reading could
        # show red right at its own small top edge.
        meters_row = QtWidgets.QHBoxLayout()
        meters_row.setContentsMargins(0,0,0,0); meters_row.setSpacing(10)

        font_lbl = QtGui.QFont("Monospace", 7); font_lbl.setBold(True)
        font_r   = QtGui.QFont("Monospace", 9); font_r.setBold(True)

        # -- Live column (existing meter, shrunk from the top to make
        # room for the new "Live" label above it) --
        live_col = QtWidgets.QVBoxLayout(); live_col.setSpacing(2)
        live_lbl = QtWidgets.QLabel("Live")
        live_lbl.setFont(font_lbl); live_lbl.setStyleSheet("color:#555;")
        ...
        live_col.addWidget(self._dc_readout)
        live_col.addSpacing(4)
        self._dc_live_meter = SegmentedMeter(n_segments=8, max_value=8.0)
        self._dc_live_meter.setFixedHeight(60)   # shrunk from the top --
                                                  # was effectively taller
                                                  # (stretch-filled) before
        ...
        live_bar_row.addStretch()
        live_col.addLayout(live_bar_row)
        meters_row.addLayout(live_col, 1)

        # -- Peak column (new: label, numeric readout, and its own meter,
        # holding the highest value seen until 10s of inactivity) --
        peak_col = QtWidgets.QVBoxLayout(); peak_col.setSpacing(2)
        peak_lbl = QtWidgets.QLabel("Peak")
        peak_lbl.setFont(font_lbl); peak_lbl.setStyleSheet("color:#555;")
        ...
        peak_col.addWidget(self._dc_peak_readout)
        peak_col.addSpacing(4)
        self._dc_peak_meter = SegmentedMeter(n_segments=8, max_value=8.0)
        self._dc_peak_meter.setFixedHeight(60)
        ...
        peak_bar_row.addStretch()
        peak_col.addLayout(peak_bar_row)

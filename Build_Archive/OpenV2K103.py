...
'en': {
    ...
    'power_last_action_count':      'Last Action Pulse Count:',
...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/8/12 - Version 103)")
    ...
    def _build_gui(self):
        ...
        # Description text -- moved up another 10px along with the dropdowns
        ...
        # TX button moved up another 20px.
        tx_vbox.addSpacing(0)
    ...
    def _cb_generate_espeak(self):
        ...
        self._log("Generate Voice clicked -- text='{}' ({} chars)".format(
            text[:24], len(text)))
        self.zcp.reset_last_action_count()   # zero the per-press pulse count
        self._update_power_calc()
        if not text:

...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        # Format: YYYY/M/D
        self.setWindowTitle("OpenV2K (2026/8/16 - Version 155)")
    ...
    def _cb_generate_espeak(self):
        ...
        # this is what the waterfall's active-area measurement should
        # roughly match (see _generate_waterfall's checksum check).
        self._last_espeak_speech_ms = len(samples) / self.AUDIO_RATE * 1000.0
        ...
        try:
            ...
            if self._last_espeak_speech_ms is not None:
                ...
                if src_ms > 0:
                    ...
                    self._log(
                        "Checksum: active={:.0f}ms vs eSpeak WAV={:.0f}ms "
                        "(ratio={:.2f}x) -- {}".format(
                            dur_ms, src_ms, ratio,
                            "OK" if tol_ok else

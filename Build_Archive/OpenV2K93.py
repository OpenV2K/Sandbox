...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/8/12 - Version 93)")
    ...
    def _build_gui(self):
        ...
        pc_outer.setContentsMargins(0, 0, 0, 0); pc_outer.setSpacing(2)
    ...
    def _update_power_calc(self):
        ...
        All Joule values use 2-decimal scientific notation (#.## J) --
        compact enough to avoid word-wrap even for longer languages.
        """
        ...
        for p_w in self._POWER_LEVELS_W:
            total_j = count * pulse_s * p_w
            total_parts.append("{:.2e} J@{}".format(total_j, _tag(p_w)))
        self._power_count_lbl.setText(
            "{} {}   {} {}".format(
                _tr("power_session_count"), count,
                _tr("power_total_energy"), "  ".join(total_parts)))

        # Row 2: Power Per Pulse (3 power tiers)
        perpulse_parts = []
        for p_w in self._POWER_LEVELS_W:
            energy_j = pulse_s * p_w
            perpulse_parts.append("{:.2e} J@{}".format(energy_j, _tag(p_w)))

...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/8/12 - Version 92)")
    ...
    def _build_gui(self):
        ...
        self._power_calc_title_lbl.setStyleSheet(
            "font-size:9pt; font-weight:bold; color:#8B0000;")   # dark red
        pc_title_row.addWidget(self._power_calc_title_lbl)
        pc_title_row.addStretch(1)
        ...
        self._tx_panel.setMinimumHeight(224)
        ...
        self._save_panel.setMinimumHeight(224)

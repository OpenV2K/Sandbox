...
class WaveHeaderWidget(QtWidgets.QWidget):
    ...
    # (frontmost), mirroring the original's white top layer.  Lightened
    # overall per request.
    _LAYERS = [
        (10.0, +1, QtGui.QColor(248, 248, 248), 255),
        ( 8.0, -1, QtGui.QColor(244, 244, 244), 255),
        ( 6.0, +1, QtGui.QColor(240, 240, 240), 255),
        ( 4.0, -1, QtGui.QColor(235, 235, 235), 255),
    ]
...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        # Format: YYYY/M/D
        self.setWindowTitle("OpenV2K (2026/8/16 - Version 137)")

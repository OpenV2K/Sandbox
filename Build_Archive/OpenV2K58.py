...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/7/25 - Version 58)")
    ...
    def _build_blocks(self):
        ...
        # alpha=5e-4 -> ~50ms time constant at 48kHz.
        # The old 2e-5 (~1s TC) barely registered a 300ms word like "one".
        self.dc_probe = analog.probe_avg_mag_sqrd_f(0, 5e-4)
    ...
    def _generate_waterfall(self, iq_path):
        try:
            ...
            self._log(
                ...
                .format(dur_ms, width_px, int(9 * DPI), PX_PER_MS))
            ...
            fig.suptitle(
                ...
                '{:.0f} px/ms  |  {}x{} px  (scroll horizontally)'
                .format(os.path.basename(iq_path),
                        dur_ms, step_us,
                        PX_PER_MS, width_px, int(9 * DPI)),
                fontsize=9)

...
class PulseHeaderWidget(QtWidgets.QWidget):
    ...
    MIN_SILENCE = 1
    MAX_SILENCE = 6
    BASELINE_Y_PX = 42.0   # 4px above the 46px-tall widget's bottom edge
    ...
    def paintEvent(self, event):
        p = QtGui.QPainter(self)   # no antialiasing -- sharp rectangle
                                    ...
                                    # cheaper to render
        r = self.rect()
        seq_w = self.N_TICKS * self.TICK_PX
        ...
        p.setPen(QtGui.QPen(self.LINE_COLOR, 1))
...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        # Format: YYYY/M/D
        self.setWindowTitle("OpenV2K (2026/8/16 - Version 141)")

...
class SegmentedMeter(QtWidgets.QWidget):
    ...
    """
    SEGMENT_H = 10   # px per segment, excluding gaps
...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        # Format: YYYY/M/D
        self.setWindowTitle("OpenV2K (2026/8/16 - Version 132)")
    ...
    def _build_gui(self):
        ...
        live_col.addSpacing(8)   # was 10 -- 2px less, shifts meter up
        ...
        live_col.addStretch(1)   # leftover space goes BELOW the meter,
                                  # not into it -- keeps its top anchored
        ...
        peak_col.addSpacing(8)   # was 10 -- 2px less, shifts meter up
        ...
        peak_col.addStretch(1)   # leftover space goes BELOW the meter

...
#
# OpenV2K14.py -- Zero-Crossing Pulse Transmitter
# ================================================
# Requirements:
...
# -- Optional matplotlib for waterfall ----------------------------------------
try:
    import matplotlib
    matplotlib.use('Agg')
...
# =============================================================================
#  Section Header widget  (tab-style, draws its own top rule)
# =============================================================================

class SectionHeader(QtWidgets.QWidget):
    """
    Bold monospace section header with tab-style border decoration.

    Draws at paint time:
      y=0  ===========================  full-width horizontal rule
                        |               vertical line (right of text)
           HEADER TEXT  |
           =============+               short underline + corner
    """
    _PT  = 12    # font point size (slightly larger than before)
    _GAP = 7     # px gap: top-rule -> text, and text -> underline
    _ML  = 2     # left text margin
    _RP  = 14    # extra px right of text before corner
    ...
    def paintEvent(self, event):
        ...
        # Full-width rule at top of widget (serves as section separator)
        p.setPen(pen_rule)
        p.drawLine(0, 0, w, 0)
        ...
        # Short underline + vertical tab line
        line_y  = gap + self._th + gap
        line_x2 = lm + self._tw + self._RP
        p.setPen(pen_rule)
        p.drawLine(lm,      line_y, line_x2, line_y)   # short horiz underline
        p.drawLine(line_x2, line_y, line_x2, 0)         # vertical up to top rule
...
class LabelledSlider(QtWidgets.QWidget):
    def __init__(self, label, lo, hi, step, default,
        ...
        self._slider.setMinimumWidth(200)   # wider than before
        self._slider.setMaximumWidth(320)
        ...
        row.addSpacing(36)    # ~1 cm gap before readout
...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/7/23 - Version 14)")
    ...
    def _build_gui(self):
        ...
        vbox.setSpacing(0)   # SectionHeader widgets manage their own top rule
        ...
        # Restored full-detail label text
        ...
        vbox.addSpacing(10)    # original 5 + extra
        ...
        # =====================================================================
        # Section 3: SDR Output  (hline only -- no section header label)
        # =====================================================================
        ...
        tx_vbox.addSpacing(12)   # extra whitespace above TX button

...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/7/25 - Version 55)")
    ...
    def _build_gui(self):
        ...
        self._chk_hwrect.setToolTip(
            "Replaces negatives with -1e-6 so ZCP only detects crossings at\n"
            "positive-lobe boundaries.  Roughly halves ZCR for voiced speech.\n"

...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/8/12 - Version 100)")
    ...
    def _build_gui(self):
        ...
        tx_vbox.setContentsMargins(0,4,4,4); tx_vbox.setSpacing(0)

...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/8/12 - Version 90)")
    ...
    def _build_gui(self):
        ...
        # Empty for now; will hold rolling pulse counts and calculated
        # pulse energy per burst (Joules) in a future pass.

...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/8/14 - Version 126)")
    ...
    def _build_gui(self):
        ...
        # Horizontal divider, directly above "Duty Cycle" -- spans from
        # the vertical divider's x-position (centre) to the right edge.
        # The invisible left half (stretch=1) matches live_col's width,
        # so the visible line itself only occupies the right half,
        # matching peak_col's width -- i.e. centre-to-right-edge.
        hline_row = QtWidgets.QHBoxLayout()
        hline_row.setContentsMargins(0,0,0,0); hline_row.setSpacing(0)
        hline_row.addStretch(1)

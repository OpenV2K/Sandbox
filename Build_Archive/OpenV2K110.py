...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/8/14 - Version 110)")
    ...
    def _build_gui(self):
        ...
        self._mic_panel = SwapPanel(divider_side='right')  # left member of its pair
        ...
        self._es_panel = SwapPanel(divider_side='left')  # right member of its pair
        ...
        self._tx_panel = SwapPanel(divider_side='right')  # left member of its pair
        ...
        self._save_panel = SwapPanel(divider_side='left')  # right member of its pair

...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/7/23 - Version 33)")
    ...
    def _build_gui(self):
        ...
        # Right spacer = same width as Event Log button -> title stays centred
        self._tr_spacer = QtWidgets.QWidget()
        self._tr_spacer.setFixedWidth(self._log_btn.sizeHint().width())
        tr.addWidget(self._tr_spacer)

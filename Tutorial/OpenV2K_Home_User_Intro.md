...
- **Computer Science / Software Engineering** — a full PyQt5 application: custom `QPainter`-based widgets, threaded audio playback, an XML-backed 49-language translation system with English-only fallback, and every DSP stage implemented as its own `gr.sync_block` Python subclass.

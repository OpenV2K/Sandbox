...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/7/23 - Version 41)")
    ...
    def _build_gui(self):
        ...
        tx_vbox.addSpacing(5)    # description sits 5px above the dropdowns

        # Frequency and TX Power side by side (half the original vertical space)
        # Placed BEFORE the stretch so TX button floats to the bottom like Record IQ
        ...
        # Stretch now sits between the dropdowns and the TX button,
        # pushing the TX button to the bottom to match Record IQ's position

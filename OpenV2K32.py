...
class OpenV2K(gr.top_block, QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("OpenV2K (2026/7/23 - Version 32)")
    ...
    def _cb_generate_espeak(self):
        ...
        if cmd_found is None:
            ...
            self._log("ERROR: espeak-ng not installed"); return
        ...
        try:
            ...
            self._log("ERROR WAV: {}".format(e)); return
